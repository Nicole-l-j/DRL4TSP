...
def get_options(args=None):
    ...
    parser.add_argument('--min_size', type=int, default=50, help="The minimum size of the problem graph")
    parser.add_argument('--max_size', type=int, default=50, help="The maximum size of the problem graph")
    parser.add_argument('--neighbors', type=float, default=25, help="The k-nearest neighbors for graph sparsification")
    parser.add_argument('--knn_strat', type=str, default=None, help="Strategy for k-nearset neighbors (None/percentage)")
    ...
    parser.add_argument('--accumulation_steps', type=int, default=1,
                        help="Gradient accumulation step during training"
                             "(effective batch_size = batch_size * accumulation_step)")
    ...
    parser.add_argument('--encoder', default='gnn', help="Graph encoder")
    parser.add_argument('--embedding_dim', type=int, default=128, help='Dimension of input embedding')
    parser.add_argument('--hidden_dim', type=int, default=128, help='Dimension of hidden layers in Enc/Dec')
    parser.add_argument('--n_encode_layers', type=int, default=3,
                        help='Number of layers in the encoder/critic network')
    parser.add_argument('--aggregation', default='max', help="Neighborhood aggregation function: 'sum'/'mean'/'max'")
    ...
    parser.add_argument('--normalization', default='layer',
                        help="Normalization type: 'batch'/'layer'/'graph'/'None'")
