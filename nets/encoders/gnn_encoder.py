...
class GNNLayer(nn.Module):
    ...
    def __init__(self, hidden_dim, aggregation="sum", norm="batch", learn_norm=True, track_norm=False, gated=False):
        """
        Args:
    ...
    def forward(self, h, e, graph):
        ...
        # Normalize node features by adjacencyNodeNormalization again
        h = self.norm_adjacency_h(h, graph, gates)
